...
# We use standardized data in this Python document. 
...
Inflation_Unemploymt_df['Unemployment Rate Standardized'] = (Inflation_Unemploymt_df['Unemployment Rate'] -Unemployment_mean)/(Unemployment_std) 
...
AnnualInf_mean = Inflation_Unemploymt_df['Unemployment Rate'].mean()
AnnualInf_std = Inflation_Unemploymt_df['Unemployment Rate'].std()

Inflation_Unemploymt_df['Annual Inflation Rate Standardized'] = (Inflation_Unemploymt_df['Annual Inflation Rate'] -AnnualInf_mean)/(AnnualInf_std) 
...
Inf_Unem = Inflation_Unemploymt_df2[['Unemployment Rate Standardized', 'Annual Inflation Rate Standardized']].to_numpy()
...
# For standardized data, the case of 6 clusters also seems to yield interesting statistical results. So we will choose to work with 6 clusters in this case so as to divide the data more finely.
num = 6
