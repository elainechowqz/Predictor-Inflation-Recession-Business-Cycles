...
Inflation_Unemploymt_df['Unemployment Rate Standardized'] = (
    Inflation_Unemploymt_df['Unemployment Rate'] - Unemployment_mean)/(Unemployment_std)
...
Inflation_Unemploymt_df['Annual Inflation Rate Standardized'] = (
    Inflation_Unemploymt_df['Annual Inflation Rate'] - AnnualInf_mean)/(AnnualInf_std)
...
Inf_Unem = Inflation_Unemploymt_df2[[
    'Unemployment Rate Standardized', 'Annual Inflation Rate Standardized']].to_numpy()
